#ifndef VSDX12RENDERER_H
#define VSDX12RENDERER_H
...
namespace VSEngine2
{
	...
	class VSDX12RENDERER_API VSDX12Renderer : public VSRenderer
	{
	public:
		VSDX12Renderer(HWND hMainWindow, unsigned int uiScreenWidth, unsigned int uiScreenHeight, bool bIsWindowed,
			unsigned int uiAnisotropy, unsigned int uiMultisample,
			ChildWindowInfo * pChildWindow, int uiNumChildWindow);
		virtual ~VSDX12Renderer();
	...
	protected:
		...
		static VSDx12ShaderInclude * ms_pDx11IncludeShader;
