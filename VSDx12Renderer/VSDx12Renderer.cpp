...
VSDx12ShaderInclude * VSDX12Renderer::ms_pDx11IncludeShader = NULL;
TCHAR VSDX12Renderer::ms_cVertexShaderProgramVersion[] = _T("vs_5_0");
TCHAR VSDX12Renderer::ms_cPixelShaderProgramVersion[] = _T("ps_5_0");
TCHAR VSDX12Renderer::ms_cGeometryShaderProgramVersion[] = _T("gs_5_0");
TCHAR VSDX12Renderer::ms_cGDomainShaderProgramVersion[] = _T("ds_5_0");
TCHAR VSDX12Renderer::ms_cHullShaderProgramVersion[] = _T("hs_5_0");
VSString VSDX12Renderer::ms_IncludeShader;
VSString VSDX12Renderer::ms_DynamicShader;
VSAdapterInfo	VSDX12Renderer::ms_AdapterInfo[5];
UINT VSDX12Renderer::ms_uiAdapterNum = 0;
IDXGIFactory* VSDX12Renderer::ms_pDXGI = NULL;
DWORD VSDX12Renderer::ms_dwAlphaBlend[] =
{
	D3D11_BLEND_ZERO,
	D3D11_BLEND_ONE,
...
DWORD VSDX12Renderer::ms_dwAlphaBlendOP[] =
{
	D3D11_BLEND_OP_ADD,
...
DWORD VSDX12Renderer::ms_dwCullType[] =
{
	D3D11_CULL_NONE,
	D3D11_CULL_FRONT,
	D3D11_CULL_BACK
};
DWORD VSDX12Renderer::ms_dwStencilOperation[] =
{
...
DWORD VSDX12Renderer::ms_dwCompare[] =
{
...
DWORD VSDX12Renderer::ms_dwTextureFormatType[] =
{
...
DWORD VSDX12Renderer::ms_dwSRGBTextureFormatType[] =
{
...
DWORD VSDX12Renderer::ms_dwTextureFilterType[VSSamplerDesc::FM_MAX][VSSamplerDesc::FM_MAX][VSSamplerDesc::FM_MAX] =
{
...
DWORD VSDX12Renderer::ms_dwTextureAddrType[] =
{
...
DWORD VSDX12Renderer::ms_dwPrimitiveType[] =
{
	D3D11_PRIMITIVE_TOPOLOGY_POINTLIST,
	D3D11_PRIMITIVE_TOPOLOGY_LINELIST,
	D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST
};
DWORD VSDX12Renderer::ms_dwDevTypes[] = 
{ 
	D3D_DRIVER_TYPE_HARDWARE,
	D3D_DRIVER_TYPE_REFERENCE
};
DWORD VSDX12Renderer::ms_dwMultiSampleTypes[] =
{
	1 ,
	2 ,
	4 ,
...
DWORD VSDX12Renderer::ms_dwLockFlag[] = 
{
	D3D11_MAP_WRITE_NO_OVERWRITE,
	D3D11_MAP_WRITE_DISCARD,
	D3D11_MAP_READ
};
DWORD VSDX12Renderer::ms_dwVertexFormatDateType[] = 
{
	DXGI_FORMAT_R32_FLOAT,
	DXGI_FORMAT_R32G32_FLOAT,
...
TCHAR* VSDX12Renderer::ms_dwVertexFormatClareType[] =
{
	"float ",
	"float2 ",
	"float3 ",
...
TCHAR* VSDX12Renderer::ms_dwVertexFormatSemantics[] =
{
	"POSITION",
	"TEXCOORD",
	"NORMAL",
...
int VSDX12Renderer::GetRendererType() const
{

	return VSRenderer::RAT_DIRECTX12;
}
const TCHAR * VSDX12Renderer::GetRendererStringType() const
{
	return _T("DX11Renderer");
}
VSDX12Renderer::VSDX12Renderer(HWND hMainWindow, unsigned int uiScreenWidth, unsigned int uiScreenHeight, bool bIsWindowed,
...
IMPLEMENT_PRIORITY(VSDX12Renderer)
IMPLEMENT_INITIAL_ONLY_BEGIN(VSDX12Renderer)
ADD_PRIORITY(VSResourceManager);
ADD_INITIAL_FUNCTION_WITH_PRIORITY(InitialDefaultState)
ADD_TERMINAL_FUNCTION(TerminalDefaultState);
IMPLEMENT_INITIAL_ONLY_END
bool VSDX12Renderer::InitialDefaultState()
{
	...
	VSString RenderAPIPre = VSResourceManager::GetRenderTypeShaderPath(RAT_DIRECTX12);
	...
	ms_pDx11IncludeShader = VS_NEW VSDx12ShaderInclude();
	VSMAC_ASSERT(ms_pDx11IncludeShader)
	return 1;
}
bool VSDX12Renderer::TerminalDefaultState()
{
	VSMAC_DELETE(ms_pDx11IncludeShader);
	VSMAC_RELEASE(ms_pDXGI);
	return 1;
}
void VSDX12Renderer::ClearBuffers(unsigned int uiClearFlag)
{ 
	if (!uiClearFlag)
	{
		return;
...
void VSDX12Renderer::ClearZBuffer()
{
	ClearDepthStencilView(D3D11_CLEAR_DEPTH, m_fClearDepth, m_uiClearStencil);
	
}
void VSDX12Renderer::ClearStencilBuffer()
{ 
	ClearDepthStencilView(D3D11_CLEAR_STENCIL, m_fClearDepth, m_uiClearStencil);
	
}
void VSDX12Renderer::ClearBuffers()
{
	ClearBuffers(CF_COLOR | CF_DEPTH |CF_STENCIL);
}
unsigned int VSDX12Renderer::SetDepthStencilState(VSDepthStencilState * pDepthStencilState, bool bForceSet)
{
...
unsigned int VSDX12Renderer::SetRasterizerState(VSRasterizerState * pRasterizerState, bool bForceSet)
{
...
void VSDX12Renderer::ClearBuffers(unsigned int uiClearFlag, int iXPos, int iYPos, int iWidth,
	int iHeight)
{
...
void VSDX12Renderer::ClearBackBuffer(int iXPos, int iYPos, int iWidth,
	int iHeight)
{
// 	VSRasterizerState * pEnableScissor = ((VSRasterizerState *)VSRasterizerState::GetScissorEnable());
// 	if (!LoadRasterizerState(pEnableScissor))
...
void VSDX12Renderer::ClearZBuffer(int iXPos, int iYPos, int iWidth,
	int iHeight)
{
// 	VSRasterizerState * pEnableScissor = ((VSRasterizerState *)VSRasterizerState::GetScissorEnable());
// 	if (!LoadRasterizerState(pEnableScissor))
...
void VSDX12Renderer::ClearStencilBuffer(int iXPos, int iYPos, int iWidth,
	int iHeight)
{
// 	VSRasterizerState * pEnableScissor = ((VSRasterizerState *)VSRasterizerState::GetScissorEnable());
// 	if (!LoadRasterizerState(pEnableScissor))
...
void VSDX12Renderer::ClearBuffers(int iXPos, int iYPos, int iWidth,
	int iHeight)
{
// 	VSRasterizerState * pEnableScissor = ((VSRasterizerState *)VSRasterizerState::GetScissorEnable());
// 	if (!LoadRasterizerState(pEnableScissor))
...
bool VSDX12Renderer::SetViewPort(VSViewPort *pViewPort)
{
...
bool VSDX12Renderer::UseWindow(int uiWindowID)
{ 
...
bool VSDX12Renderer::CooperativeLevel()
{ 
	return true; 
}
bool VSDX12Renderer::BeginRendering()
{ 
	VSRenderer::BeginRendering();
	return true;
}
bool VSDX12Renderer::EndRendering()
{ 
...
unsigned int VSDX12Renderer::SetTexture(VSTexture* pTexture, unsigned int i)
{ 
...
ID3DBlob* VSDX12Renderer::CreateVertexFormatShader(const VSArray<VSVertexFormat::VERTEXFORMAT_TYPE>& Layouts)
{
...
bool VSDX12Renderer::OnLoadVBufferFormat(VSVertexFormat * pVertexFormat, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseVBufferFormat(VSResourceIdentifier* pVBufferID)
{ 
	VSMAC_DELETE(pVBufferID);
	return true;
}
void VSDX12Renderer::DeviceLost()
{ 
...
void VSDX12Renderer::ResetDevice()
{ 
	HRESULT hResult = NULL;
...
bool VSDX12Renderer::ChangeScreenSize(unsigned int uiWidth, unsigned int uiHeight, bool bWindow)
{
...
bool VSDX12Renderer::DrawMesh(VSGeometry * pGeometry, VSRenderState * pRenderState, VSVShader * pVShader, VSPShader * pPShader, VSGShader * pGShader)
{
...
bool VSDX12Renderer::DrawScreen(SCREEN_QUAD_TYPE ScreenQuad[4])
{
...
bool VSDX12Renderer::DrawScreen(SCREEN_QUAD_TYPE * pScreenBuffer, unsigned int uiVertexNum,VSUSHORT_INDEX * pIndexBuffer, unsigned int uiIndexNum)
{
...
bool VSDX12Renderer::DrawScreenFont(SCREEN_FONT_TYPE * pScreenFontBuffer, unsigned int uiVertexNum,
...
unsigned int VSDX12Renderer::SetBlendState(VSBlendState * pBlendState, bool bForceSet)
{ 
...
void VSDX12Renderer::SetClipPlane(VSArray<VSPlane3> &Plane, bool bEnable){ VSMAC_ASSERT(0); return; }
void VSDX12Renderer::SetScissorRect(VSArray<VSRect2> &Rect, bool bEnable)
{ 
...
void VSDX12Renderer::SetVShaderConstant(VSVShader * pShader)
{
...
void VSDX12Renderer::SetVShaderSampler(VSVShader * pShader)
{
	VSMemset(m_pTexAllStateBuffer, 0, sizeof(VSTexAllState *)* MAX_TEXTURE_BUFFER);
	if (pShader->m_bCreatePara)
	{
...
void VSDX12Renderer::SetPShaderSampler(VSPShader * pShader)
{
	VSMemset(m_pTexAllStateBuffer, 0, sizeof(VSTexAllState *)* MAX_TEXTURE_BUFFER);
	if (pShader->m_bCreatePara)
	{
...
void VSDX12Renderer::SetDShaderSampler(VSDShader * pShader)
{
	VSMemset(m_pTexAllStateBuffer, 0, sizeof(VSTexAllState *)* MAX_TEXTURE_BUFFER);
	if (pShader->m_bCreatePara)
	{
...
void VSDX12Renderer::SetHShaderSampler(VSHShader * pShader)
{
	VSMemset(m_pTexAllStateBuffer, 0, sizeof(VSTexAllState *)* MAX_TEXTURE_BUFFER);
	if (pShader->m_bCreatePara)
	{
...
void VSDX12Renderer::SetGShaderSampler(VSGShader * pShader)
{
	VSMemset(m_pTexAllStateBuffer, 0, sizeof(VSTexAllState *)* MAX_TEXTURE_BUFFER);
	if (pShader->m_bCreatePara)
	{
...
unsigned int VSDX12Renderer::SetVShader(VSVShader * pVShader)
{
	if (!pVShader)
		return FRI_FAIL;
...
void VSDX12Renderer::SetPShaderConstant(VSPShader * pShader)
{
...
void VSDX12Renderer::SetGShaderConstant(VSGShader * pShader)
{
	if (!pShader->m_bCreatePara)
	{
		return;
...
void VSDX12Renderer::SetHShaderConstant(VSHShader * pShader)
{
	if (!pShader->m_bCreatePara)
	{
		return;
...
void VSDX12Renderer::SetDShaderConstant(VSDShader * pShader)
{
	if (!pShader->m_bCreatePara)
	{
		return;
...
unsigned int VSDX12Renderer::SetDShader(VSDShader * pDShader)
{
...
unsigned int VSDX12Renderer::SetHShader(VSHShader * pHShader)
{
...
unsigned int VSDX12Renderer::SetGShader(VSGShader * pGShader)
{
...
unsigned int VSDX12Renderer::SetPShader(VSPShader * pPShader)
{  
	if (!pPShader)
		return FRI_FAIL;
...
unsigned int VSDX12Renderer::SetVBuffer(VSVertexBuffer * pVBuffer)
{
...
unsigned int VSDX12Renderer::SetIBuffer(VSIndexBuffer* pIBuffer)
{
...
unsigned int VSDX12Renderer::SetVTexture(VSTexture* pTexture, unsigned int i)
{ 
...
unsigned int VSDX12Renderer::SetGTexture(VSTexture* pTexture, unsigned int i)
{
...
unsigned int VSDX12Renderer::SetDTexture(VSTexture* pTexture, unsigned int i)
{
...
unsigned int VSDX12Renderer::SetHTexture(VSTexture* pTexture, unsigned int i)
{
...
unsigned int VSDX12Renderer::SetHSamplerState(VSSamplerState * pSamplerState, unsigned int i, bool bForceSet)
{
...
unsigned int VSDX12Renderer::SetDSamplerState(VSSamplerState * pSamplerState, unsigned int i, bool bForceSet)
{
...
unsigned int VSDX12Renderer::SetGSamplerState(VSSamplerState * pSamplerState, unsigned int i, bool bForceSet)
{
...
unsigned int VSDX12Renderer::SetVSamplerState(VSSamplerState * pSamplerState, unsigned int i, bool bForceSet)
{
...
unsigned int VSDX12Renderer::SetSamplerState(VSSamplerState * pSamplerState, unsigned int i, bool bForceSet)
{
...
bool VSDX12Renderer::SetRenderTargets(VSRenderTarget *pRenderTarget[], unsigned int uiNum)
{ 
...
bool VSDX12Renderer::EndRenderTargets(VSRenderTarget *pRenderTarget[], unsigned int uiNum)
{
...
bool VSDX12Renderer::SetDepthStencilBuffer(VSDepthStencil * pDepthStencilBuffer)
{ 
...
bool VSDX12Renderer::EndDepthStencilBuffer(VSDepthStencil * pDepthStencilBuffer)
{ 
...
bool VSDX12Renderer::SetVShaderProgram(VSVShader*	pVShaderProgram)
{ 
...
bool VSDX12Renderer::SetGShaderProgram(VSGShader*pGShaderProgram)
{
...
bool VSDX12Renderer::SetDShaderProgram(VSDShader*pDShaderProgram)
{
...
bool VSDX12Renderer::SetHShaderProgram(VSHShader*pHShaderProgram)
{
...
bool VSDX12Renderer::SetPShaderProgram(VSPShader*pPShaderProgram)
{
...
D3D_SHADER_MACRO * VSDX12Renderer::GetDefine(VSMap<VSString, VSString> & Define)
{
	if (Define.GetNum())
	{
...
//Load Release
bool VSDX12Renderer::OnLoadVShaderProgram(VSVShader * pVShaderProgram, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseVShaderProgram(VSResourceIdentifier * pVShaderProgramID)
{
...
bool VSDX12Renderer::OnLoadGShaderProgram(VSGShader * pGShaderProgram, VSResourceIdentifier *&pID)
{
...
bool VSDX12Renderer::OnLoadDShaderProgram(VSDShader * pDShaderProgram, VSResourceIdentifier *&pID)
{
...
bool VSDX12Renderer::OnLoadHShaderProgram(VSHShader * pHShaderProgram, VSResourceIdentifier *&pID)
{
...
bool VSDX12Renderer::OnLoadPShaderProgram(VSPShader* pPShaderProgram, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleasePShaderProgram(VSResourceIdentifier* pPShaderProgramID)
{
...
bool VSDX12Renderer::OnReleaseGShaderProgram(VSResourceIdentifier * pGShaderProgramID)
{
...
bool VSDX12Renderer::OnReleaseDShaderProgram(VSResourceIdentifier * pDShaderProgramID)
{
...
bool VSDX12Renderer::OnReleaseHShaderProgram(VSResourceIdentifier * pHShaderProgramID)
{
...
bool VSDX12Renderer::OnLoadTexture(VSTexture * pTexture, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseTexture(VSResourceIdentifier * pTextureID)
{
	VSMAC_DELETE(pTextureID);
	return 1;
}

bool VSDX12Renderer::OnLoadDepthStencil(VSDepthStencil * pDepthStencil, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseDepthStencil(VSResourceIdentifier * pDepthStencilID)
{ 
	VSMAC_DELETE(pDepthStencilID);
	return 1;
}

bool VSDX12Renderer::OnLoadRenderTarget(VSRenderTarget * pRenderTarget, VSResourceIdentifier *&pID)
{ 
	if (!pRenderTarget)
	{
		return false;
...
bool VSDX12Renderer::OnReleaseRenderTarget(VSResourceIdentifier * pRenderTarget)
{ 
	VSMAC_DELETE(pRenderTarget);
	return true;
}

bool VSDX12Renderer::OnLoadVBufferDate(VSVertexBuffer * pVBuffer, VSResourceIdentifier *&pID)
{
...
bool VSDX12Renderer::OnReleaseVBufferDate(VSResourceIdentifier* pVBufferID)
{
	VSMAC_DELETE(pVBufferID);
	return 1;
}
...
bool VSDX12Renderer::OnLoadIBuffer(VSIndexBuffer* pIBuffer, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseIBuffer(VSResourceIdentifier* pIBufferID)
{ 
...
bool VSDX12Renderer::OnLoadBlendState(VSBlendState * pBlendState, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseBlendState(VSResourceIdentifier * pBlendStateID)
{ 
	VSMAC_DELETE(pBlendStateID);
	return 1;
}

bool VSDX12Renderer::OnLoadDepthStencilState(VSDepthStencilState * pDepthStencilState, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseDepthStencilState(VSResourceIdentifier * pDepthStencilStateID)
{ 
	VSMAC_DELETE(pDepthStencilStateID);
	return 1;
}

bool VSDX12Renderer::OnLoadRasterizerState(VSRasterizerState * pRasterizerState, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseRasterizerState(VSResourceIdentifier * pRasterizerStateID)
{ 
	VSMAC_DELETE(pRasterizerStateID);
	return 1;
}

bool VSDX12Renderer::OnLoadSamplerState(VSSamplerState * pSamplerState, VSResourceIdentifier *&pID)
{ 
...
bool VSDX12Renderer::OnReleaseSamplerState(VSResourceIdentifier * pSamplerStateID)
{ 
	VSMAC_DELETE(pSamplerStateID);
	return 1;
}

unsigned int VSDX12Renderer::SetVertexFormat(VSVertexFormat * pVertexFormat)
{ 
...
void * VSDX12Renderer::Lock(VSVertexBuffer * pVertexBuffer)
{ 
	if (!pVertexBuffer)
		return NULL;
...
void VSDX12Renderer::UnLock(VSIndexBuffer * pIndexBuffer)
{
	if (!pIndexBuffer)
		return;
...
void VSDX12Renderer::UnLock(VSVertexBuffer * pVertexBuffer)
{ 
	if (!pVertexBuffer)
		return;
...
void * VSDX12Renderer::Lock(VSIndexBuffer * pIndexBuffer)
{ 
	if (!pIndexBuffer)
		return NULL;
...
void * VSDX12Renderer::Lock(VSTexture * pTexture, unsigned int uiLevel, unsigned int uiFace)
{ 
	if (!pTexture)
		return NULL;
...
void VSDX12Renderer::UnLock(VSTexture * pTexture, unsigned int uiLevel, unsigned int uiFace)
{ 
	if (!pTexture)
		return;
...
bool VSDX12Renderer::CopyResourceBuffer(VS2DTexture * pSource, VSCubeTexture * pDest, unsigned int uiFace)
{ 
...
void * VSDX12Renderer::Lock(VSRenderTarget * pRenderTarget)
{
	return NULL;
}
void VSDX12Renderer::UnLock(VSRenderTarget * pRenderTarget)
{

}

void * VSDX12Renderer::Lock(VSDepthStencil * pDepthStencil)
{
	return NULL;
}
void VSDX12Renderer::UnLock(VSDepthStencil * pDepthStencil)
{

}
unsigned int VSDX12Renderer::GetTextureCompressLen(unsigned int uiLen)
{
	return Max((unsigned int)1, (unsigned int)(uiLen / 4));
}
void VSDX12Renderer::GetIncludeShader(VSString &OutString)
{
	OutString = ms_IncludeShader;
}

void VSDX12Renderer::GetDynamicShader(VSString &OutString)
{
	OutString = ms_DynamicShader;
}
const VSAdapterInfo* VSDX12Renderer::GetAdapterInfo(unsigned int & uiAdapterNum)
{
	uiAdapterNum = ms_uiAdapterNum;
	return ms_AdapterInfo;
}
bool VSDX12Renderer::IsSupportMulBufferSwtich()const
{
	return false;
}
bool VSDX12Renderer::IsSupportGS()const
{
	return true;
}