...
void VSDX12Renderer::ClearBackBuffer()
{
...
void VSDX12Renderer::ClearDepthStencilView(UINT ClearFlags, float Depth, unsigned char Stencil)
{
...
void VSDX12Renderer::OMSetDepthStencilState(VSDepthStencilStateID *pDepthStencilStateID, UINT StencilRef)
{
...
void VSDX12Renderer::RSSetState(VSRasterStateID *pRasterStateID)
{
...
void VSDX12Renderer::RSSetViewports(D3D11_VIEWPORT& View)
{
	ENQUEUE_UNIQUE_RENDER_COMMAND_TWOPARAMETER(VSDx11RSSetStateCommand, ID3D11DeviceContext*, m_pDeviceContext, m_pDeviceContext,
...
void VSDX12Renderer::UseWindowEx(int uiWindowID)
{
...
void VSDX12Renderer::PSSetShaderResources(UINT StartSlot, VSTextureID *pTextureID)
{
...
bool VSDX12Renderer::CreateInputLayout(const VSArray<VSVertexFormat::VERTEXFORMAT_TYPE>& FormatArray, VSVBufferFormatID * pVBufferFormatID)
{
		...
		VSVBufferFormatID *, pVBufferFormatID, pVBufferFormatID,
	{
		...
		ID3DBlob* pCode = VSDX12Renderer::CreateVertexFormatShader(FormatArray);
		if (!pCode)
		{
			return false;
		}
...
void VSDX12Renderer::DrawDynamicScreenData(void * pScreenBuffer, unsigned int uiVertexNum, unsigned int uiVertexStride, VSUSHORT_INDEX * pIndexBuffer, unsigned int uiIndexNum)
{
	struct ScreenData
	{
		void* pScreenBuffer;
...
void VSDX12Renderer::OMSetBlendState(VSBlendStateID* pBlendStateID)
{
...
void VSDX12Renderer::RSSetScissorRects(UINT NumRects, D3D11_RECT *pRects)
{
...
void VSDX12Renderer::UpdateSubresource(ID3D11Resource **pDstResource, void *pSrcData, unsigned int uiDataSize)
{
	void *pData = pSrcData;
	if (VSResourceManager::ms_bRenderThread)
	{
...
void VSDX12Renderer::IASetVertexBuffers(VSVBufferID* pVBufferID, unsigned int uiStrides)
{
...
void VSDX12Renderer::IASetIndexBuffer(VSIBufferID* pIBufferID, DXGI_FORMAT Format)
{
...
void VSDX12Renderer::GSSetShaderResources(UINT StartSlot, VSTextureID *pTextureID)
{
...
void VSDX12Renderer::DSSetShaderResources(UINT StartSlot, VSTextureID *pTextureID)
{
...
void VSDX12Renderer::HSSetShaderResources(UINT StartSlot, VSTextureID *pTextureID)
{
...
void VSDX12Renderer::VSSetShaderResources(UINT StartSlot, VSTextureID *pTextureID)
{
...
void VSDX12Renderer::VSSetSamplers(UINT StartSlot, VSSamplerStateID* pSamplerStateID)
{
...
void VSDX12Renderer::DSSetSamplers(UINT StartSlot, VSSamplerStateID* pSamplerStateID)
{
...
void VSDX12Renderer::HSSetSamplers(UINT StartSlot, VSSamplerStateID* pSamplerStateID)
{
...
void VSDX12Renderer::GSSetSamplers(UINT StartSlot, VSSamplerStateID* pSamplerStateID)
{
...
void VSDX12Renderer::PSSetSamplers(UINT StartSlot, VSSamplerStateID* pSamplerStateID)
{
...
void VSDX12Renderer::SetRenderTargetsEx(VSRenderTargetID *pRenderTarget[], unsigned int uiNum, unsigned int uiBackMacthType)
{
...
void VSDX12Renderer::EndRenderTargetsEx(VSRenderTargetID *pRenderTarget[], unsigned int uiNum)
{
...
void VSDX12Renderer::SetDepthStencilBufferEx(VSDepthStencilID *pDepthStencilID)
{
...
void VSDX12Renderer::EndDepthStencilBufferEx(VSDepthStencilID *pDepthStencilID)
{
...
void VSDX12Renderer::VSSetShader(VSVProgramID *pVProgramID)
{
...
void VSDX12Renderer::GSSetShader(VSGProgramID *pGProgramID)
{
...
void VSDX12Renderer::HSSetShader(VSHProgramID *pHProgramID)
{
...
void VSDX12Renderer::DSSetShader(VSDProgramID *pDProgramID)
{
...
void VSDX12Renderer::PSSetShader(VSPProgramID *pPProgramID)
{
...
void VSDX12Renderer::OnLoadVShaderFromString(VSVShader * pVShaderProgram, VSVProgramID *pVProgramID)
{
	HRESULT hResult = NULL;
	ID3DBlob* pCode = NULL;
...
void VSDX12Renderer::CreateVShaderFromString(VSVShader * pVShaderProgram, VSVProgramID *pVProgramID)
{
	ENQUEUE_UNIQUE_RENDER_COMMAND_THREEPARAMETER(VSDx11CreateVShaderFromStringCommand, VSDX12Renderer *, pRenderer, this,
...
void VSDX12Renderer::CreateVShaderFromCache(VSVShader * pVShaderProgram, VSVProgramID *pVProgramID)
{
...
void VSDX12Renderer::OnLoadGShaderFromString(VSGShader* pGShaderProgram, VSGProgramID *pGProgramID)
{
	HRESULT hResult = NULL;
	ID3DBlob* pCode = NULL;
	ID3DBlob* pErrors = NULL;
...
void VSDX12Renderer::OnLoadHShaderFromString(VSHShader* pHShaderProgram, VSHProgramID *pHProgramID)
{
	HRESULT hResult = NULL;
	ID3DBlob* pCode = NULL;
	ID3DBlob* pErrors = NULL;
...
void VSDX12Renderer::OnLoadDShaderFromString(VSDShader* pDShaderProgram, VSDProgramID *pDProgramID)
{
	HRESULT hResult = NULL;
	ID3DBlob* pCode = NULL;
	ID3DBlob* pErrors = NULL;
...
void VSDX12Renderer::OnLoadPShaderFromString(VSPShader* pPShaderProgram, VSPProgramID *pPProgramID)
{
	HRESULT hResult = NULL;
	ID3DBlob* pCode = NULL;
	ID3DBlob* pErrors = NULL;
...
void VSDX12Renderer::CreatePShaderFromString(VSPShader* pPShaderProgram, VSPProgramID *pPProgramID)
{
	ENQUEUE_UNIQUE_RENDER_COMMAND_THREEPARAMETER(VSDx11CreatePShaderFromStringCommand, VSDX12Renderer *, pRenderer, this,
...
void VSDX12Renderer::CreateGShaderFromString(VSGShader* pGShaderProgram, VSGProgramID *pGProgramID)
{
	ENQUEUE_UNIQUE_RENDER_COMMAND_THREEPARAMETER(VSDx11CreateGShaderFromStringCommand, VSDX12Renderer *, pRenderer, this,
...
void VSDX12Renderer::CreateDShaderFromString(VSDShader* pDShaderProgram, VSDProgramID *pDProgramID)
{
	ENQUEUE_UNIQUE_RENDER_COMMAND_THREEPARAMETER(VSDx11CreateDShaderFromStringCommand, VSDX12Renderer *, pRenderer, this,
...
void VSDX12Renderer::CreateHShaderFromString(VSHShader* pHShaderProgram, VSHProgramID *pHProgramID)
{
	ENQUEUE_UNIQUE_RENDER_COMMAND_THREEPARAMETER(VSDx11CreateHShaderFromStringCommand, VSDX12Renderer *, pRenderer, this,
...
void VSDX12Renderer::CreateGShaderFromCache(VSGShader* pGShaderProgram, VSGProgramID *pGProgramID)
{
...
void VSDX12Renderer::CreateHShaderFromCache(VSHShader* pHShaderProgram, VSHProgramID *pHProgramID)
{
...
void VSDX12Renderer::CreateDShaderFromCache(VSDShader* pDShaderProgram, VSDProgramID *pDProgramID)
{
...
void VSDX12Renderer::CreatePShaderFromCache(VSPShader* pPShaderProgram, VSPProgramID *pPProgramID)
{
...
void VSDX12Renderer::CreateTexture1D(VS1DTexture *pTexture, D3D11_TEXTURE1D_DESC &desc, VSTextureID * pTextureID)
{
...
void VSDX12Renderer::CreateTextureCube(VSCubeTexture *pTexture, D3D11_TEXTURE2D_DESC &desc, bool bRT, VSTextureID * pTextureID)
{
...
void VSDX12Renderer::CreateTexture3D(VS3DTexture *pTexture, D3D11_TEXTURE3D_DESC &desc, VSTextureID * pTextureID)
{
...
void VSDX12Renderer::CreateTexture2D(VS2DTexture *pTexture, D3D11_TEXTURE2D_DESC &desc, bool bRT, VSTextureID * pTextureID)
{
...
void VSDX12Renderer::CreateDepth(D3D11_TEXTURE2D_DESC &desc, VSDepthStencilID * pDepthStencilID)
{
...
void VSDX12Renderer::OnLoadRenderTargetEx(unsigned int Width, unsigned int Height, DXGI_FORMAT Format, unsigned int Count,
...
void VSDX12Renderer::OnLoadVertexBufferEx(unsigned int uiOneVextexSize, unsigned int uiTotalSize, 
...
void VSDX12Renderer::OnLoadIndexBufferEx(unsigned int ByteWidth, D3D11_USAGE Usage, unsigned int CPUAccessFlags, void* pBuffer, VSIBufferID * pIBufferID)
{
...
bool VSDX12Renderer::DrawDynamicBufferMesh(VSDynamicBufferGeometry *pDBGeometry)
{
...
bool VSDX12Renderer::DrawMesh(VSGeometry * pGeometry)
{
...
bool VSDX12Renderer::DrawMesh1(VSGeometry * pGeometry)
{
...
void VSDX12Renderer::CreateBlendState(const D3D11_BLEND_DESC &desc, VSBlendStateID * pBlendStateID)
{
...
void VSDX12Renderer::CreateDepthStencilState(const D3D11_DEPTH_STENCIL_DESC depthStencilDesc, VSDepthStencilStateID * pDepthStenciStateID)
{
...
void VSDX12Renderer::CreateRasterizerState(const D3D11_RASTERIZER_DESC rasterDesc, VSRasterStateID * pRasterStateID)
{
...
void VSDX12Renderer::CreateSamplerState(const D3D11_SAMPLER_DESC& sampDesc, VSSamplerStateID * pSamplerStateID)
{
...
void VSDX12Renderer::IASetInputLayout(VSVBufferFormatID * pVBufferFormatID)
{
