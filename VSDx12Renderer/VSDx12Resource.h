#ifndef VSDX12RESOURCE_H
#define VSDX12RESOURCE_H
#ifdef VSDX12RENDERER_EXPORTS
#define  VSDX12RENDERER_API __declspec(dllexport) 
#else
#define  VSDX12RENDERER_API __declspec(dllimport)
#endif
...
namespace VSEngine2
{
	class  VSDX12RENDERER_API VSSamplerStateID : public VSResourceIdentifier
	{
	public:
		VSSamplerStateID()
		{
	...
	class  VSDX12RENDERER_API VSBlendStateID : public VSResourceIdentifier
	{
	public:
		VSBlendStateID()
		{
	...
	class  VSDX12RENDERER_API VSRasterStateID : public VSResourceIdentifier
	{
	public:
		VSRasterStateID()
		{
	...
	class  VSDX12RENDERER_API VSDepthStencilStateID : public VSResourceIdentifier
	{
	public:
	...
	class  VSDX12RENDERER_API VSVProgramID : public VSResourceIdentifier
	{
	public:
		VSVProgramID()
		{
	...
	class  VSDX12RENDERER_API VSPProgramID : public VSResourceIdentifier
	{
	public:
		VSPProgramID()
		{
	...
	class  VSDX12RENDERER_API VSGProgramID : public VSResourceIdentifier
	{
	public:
		VSGProgramID()
		{
	...
	class  VSDX12RENDERER_API VSDProgramID : public VSResourceIdentifier
	{
	public:
		VSDProgramID()
		{
	...
	class  VSDX12RENDERER_API VSHProgramID : public VSResourceIdentifier
	{
	public:
		VSHProgramID()
		{
...
// 
	class  VSDX12RENDERER_API VSRenderTargetID : public VSResourceIdentifier
	{
	public:
		VSRenderTargetID()
		{
	...
	class  VSDX12RENDERER_API VSTextureID : public VSResourceIdentifier
	{
	public:
		VSTextureID()
		{
	...
	class VSDX12RENDERER_API VSDepthStencilID : public VSResourceIdentifier
	{
	public:
		VSDepthStencilID()
		{
	...
	class VSDX12RENDERER_API VSVBufferID : public VSResourceIdentifier
	{
	public:
		VSVBufferID()
		{
	...
	class VSDX12RENDERER_API VSVBufferFormatID : public VSResourceIdentifier
	{
	public:
		VSVBufferFormatID()
		{
	...
	class VSDX12RENDERER_API VSIBufferID : public VSResourceIdentifier
	{
	public:
		VSIBufferID()
		{
