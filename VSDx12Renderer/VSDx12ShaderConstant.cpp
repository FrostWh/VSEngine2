...
void VSDX12Renderer::SetUserConstantWorldViewProjectMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX12Renderer::SetUserLightShadowMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX12Renderer::SetUserConstantWorldViewMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX12Renderer::SetUserConstantSkin(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX12Renderer::SetUserConstantLightWorldPos(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX12Renderer::SetUserConstantLightWorldDirection(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX12Renderer::SetMaterialVShaderConstant(MaterialShaderPara &MSPara,unsigned int uiPassType,VSVShader *pVShader)
{
	unsigned int ID = 0;
...
void VSDX12Renderer::SetUserConstantWorldMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSTransform World = MSPara.pGeometry->GetWorldTransform();
	VSMatrix3X3W  *TempMatrix  = (VSMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
...
void VSDX12Renderer::SetUserConstantCameraPos(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSVector3 * pCameraPos = (VSVector3 *) pShader->m_pUserConstant[ID]->GetDate();
	*pCameraPos= MSPara.pCamera->GetWorldTranslate();
	ID++;
}
void VSDX12Renderer::SetUserConstantSkyUpColor(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSColorRGBA * pColor = (VSColorRGBA *) pShader->m_pUserConstant[ID]->GetDate();
	*pColor= MSPara.m_SkyLightUpColor;
	ID++;
}
void VSDX12Renderer::SetUserConstantSkyDownColor(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSColorRGBA * pColor = (VSColorRGBA *) pShader->m_pUserConstant[ID]->GetDate();
	*pColor= MSPara.m_SkyLightDownColor;
	ID++;	
}
void VSDX12Renderer::SetUserConstantLight(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX12Renderer::SetUserConstantLightFuntionSampler(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSArray<VSLight*> & LightArray = MSPara.LightArray;
	for (unsigned int i = 0 ; i < LightArray.GetNum() ; i++)
	{
...
void VSDX12Renderer::SetUserConstantShadowSampler(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSArray<VSLight*> & LightArray = MSPara.LightArray;
	for (unsigned int i = 0 ; i < LightArray.GetNum() ; i++)
	{
...
void VSDX12Renderer::SetUserConstantFarZ(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSREAL  * Temp  = (VSREAL *)pShader->m_pUserConstant[ID]->GetDate();
	*Temp = MSPara.pCamera->GetZFar();	
	ID++;
}
void VSDX12Renderer::SetUserConstantPointLightRange(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSREAL  * Temp  = (VSREAL *)pShader->m_pUserConstant[ID]->GetDate();
...
void VSDX12Renderer::SetUserConstantInvRTWidth(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSREAL  * Temp  = (VSREAL *)pShader->m_pUserConstant[ID]->GetDate();
...
void VSDX12Renderer::SetUserConstantProjectMatrix(MaterialShaderPara &MSPara, VSShader * pShader, unsigned int& ID)
{
	VSMatrix3X3W  *TempMatrix = (VSMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
	*TempMatrix = MSPara.pCamera->GetProjMatrix();
	ID++;
}
void VSDX12Renderer::SetUserConstantViewMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSMatrix3X3W  *TempMatrix  = (VSMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
	*TempMatrix = MSPara.pCamera->GetViewMatrix();
	ID++;
}
void VSDX12Renderer::SetUserConstantViewProjectMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSMatrix3X3W  *TempMatrix  = (VSMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
	*TempMatrix = MSPara.pCamera->GetViewMatrix() * MSPara.pCamera->GetProjMatrix();
	ID++;
}
void VSDX12Renderer::SetMaterialPShaderConstant(MaterialShaderPara &MSPara,unsigned int uiPassType,VSPShader *pPShader)
{
	unsigned int ID = 0;
	if (uiPassType == VSPass::PT_MATERIAL)
	{
