...
VSString VSDX12Renderer::TexColorBuffer(const VSColorBuffer * pColorBuffer) const
{
	if (!pColorBuffer)
		return VSString();
...
VSString VSDX12Renderer::Tex2D(const VS2DTexSampler * p2DTexSampler) const
{
...
VSString VSDX12Renderer::Tex1D(const VS1DTexSampler * p1DTexSampler) const
{
...
VSString VSDX12Renderer::Mul(const VSMul * pMul) const
{
...
VSString VSDX12Renderer::Saturate(const VSSaturate * pSaturate) const
{
...
VSString VSDX12Renderer::Div(const VSDiv * pDiv) const
{
...
VSString VSDX12Renderer::Sub(const VSSub * pSub) const
{
...
VSString VSDX12Renderer::Add(const VSAdd * pAdd) const
{
...
VSString VSDX12Renderer::Dot(const VSDot * pDot) const
{
...
VSString VSDX12Renderer::MakeValue(const VSMakeValue * pMakeValue)const
{
	VSString Temp;
...
VSString VSDX12Renderer::Texture(unsigned int uiType)const
{
...
VSString VSDX12Renderer::Sampler(unsigned int uiType)const
{
...
VSString VSDX12Renderer::Float()const
{
	return VSString(_T("float "));
}

VSString VSDX12Renderer::Float2()const
{
	return VSString(_T("float2 "));
}

VSString VSDX12Renderer::Float3()const
{
	return VSString(_T("float3 "));
}

VSString VSDX12Renderer::Float4()const
{
	return VSString(_T("float4 "));
}

VSString VSDX12Renderer::Return()const
{
	return VSString(_T("return "));
}

VSString VSDX12Renderer::FloatConst(const VSString & Value1)const
{
	return Value1;
}

VSString VSDX12Renderer::Float2Const(const VSString &Value1,const VSString &Value2)const
{
	return VSString(_T("float2")) + _T("(") + Value1 + _T(",") + Value2 + _T(")");
}

VSString VSDX12Renderer::Float3Const(const VSString & Value1,
							 const VSString& Value2,const VSString &Value3)const
{
	return VSString(_T("float3")) + _T("(") + Value1 + _T(",") + Value2 + _T(",") + Value3 + _T(")");
}

VSString VSDX12Renderer::Float4Const(const VSString &Value1,const VSString &Value2,
							 const VSString &Value3,const VSString &Value4)const
{
	return VSString(_T("float4")) + _T("(") + Value1 + _T(",") + Value2 + _T(",") + Value3 + _T(",") + Value4 + _T(")");
}

void VSDX12Renderer::CustomPointLightUseString(VSString & PointLightUseString ,VSString & PointAttenuationDivString)
{
...
void VSDX12Renderer::CustomSpotLightUseString(VSString & SpotLightUseString ,VSString & SpotAttenuationDivString)
{
...
VSString VSDX12Renderer::GetValueElement(const VSString & InputString,
...
VSString VSDX12Renderer::GetValueElement(const VSPutNode * pPutNode,
								 unsigned char uiVE)const
{
...
VSString VSDX12Renderer::GetDeclareValue(const VSString &ShowName, unsigned int uiValueType, unsigned int uiRegisterIndex)const
{
	VSString OutString;
...
VSString VSDX12Renderer::GetDeclareSampler(const VSString &ShowName, unsigned int SamplerType, unsigned int uiRegisterIndex)const
{
...
VSString VSDX12Renderer::SetRegister(unsigned int uiRegisterType,unsigned int uiRegisterIndex)const
{
...
void VSDX12Renderer::CreateVInputDeclarePosition(VSVertexBuffer * pVBuffer,
								 VSString & OutString)
{
...
void VSDX12Renderer::CreateVInputDeclareTexCoord(VSVertexBuffer * pVBuffer,
								 VSString & OutString)
{
...
void VSDX12Renderer::CreateVInputDeclareNormal(VSVertexBuffer * pVBuffer,
							   VSString & OutString)
{
...
void VSDX12Renderer::CreateVInputDeclareColor(VSVertexBuffer * pVBuffer,
							  VSString & OutString)
{
...
void VSDX12Renderer::CreateVInputDeclareSkin(VSVertexBuffer * pVBuffer,
							 VSString & OutString)
{
...
void VSDX12Renderer::CreateVInputDeclare(MaterialShaderPara &MSPara,unsigned int uiPassType,
										VSString & OutString)
{
...
void VSDX12Renderer::CreateVOutputDeclarePosition(
								  VSString & OutString)
{
	OutString += _T("float4 Position:SV_POSITION;\n");
}
void VSDX12Renderer::CreateVOutputDeclareTexCoord(VSVertexBuffer * pVBuffer,unsigned int& ID,
								  VSString & OutString)
{
	for(unsigned int i = 0 ; i < pVBuffer->GetTexCoordLevel(); i++)
	{
...
void VSDX12Renderer::CreateVOutputDeclareNormal(VSVertexBuffer * pVBuffer,unsigned int& ID,
								VSString & OutString)
{
...
void VSDX12Renderer::CreateVOutputDeclareColor(VSVertexBuffer * pVBuffer,
							   VSString & OutString)
{
	for(unsigned int i = 0 ; i < pVBuffer->GetColorLevel(); i++)
	{
...
void VSDX12Renderer::CreateVOutputDeclareLocalPos(unsigned int& ID,
								  VSString & OutString)
{
	VSString TextureID  = IntToString(ID);
...
void VSDX12Renderer::CreateVOutputDeclareWorldPos(VSString & OutString)
{
	OutString += _T("float3 WorldPos:WPOS;\n");
}
void VSDX12Renderer::CreateVOutputDeclareProjectPos(unsigned int& ID,
												 VSString & OutString)
{
	VSString TextureID  = IntToString(ID);
...
void VSDX12Renderer::CreateVOutputDeclareProjectZ(unsigned int& ID,
								  VSString & OutString)
{
	VSString TextureID = IntToString(ID);
...
void VSDX12Renderer::CreateVOutputDeclare(MaterialShaderPara &MSPara,unsigned int uiPassType,
										 VSString & OutString)
{
	VSString TempDeclare;
	VSVertexBuffer * pVBuffer = MSPara.pGeometry->GetMeshDate()->GetVertexBuffer();
...
void VSDX12Renderer::CreateUserConstantWorldViewProjectMatrix(VSShader * pShader,unsigned int& ID,
											  VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantLightShadowMatrix(VSShader * pShader,unsigned int& ID,
															 VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantLightWorldPos(VSShader * pShader,unsigned int& ID,
									 VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantLightDirection(VSShader * pShader,unsigned int& ID,
									  VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantViewMatrix(VSShader * pShader,unsigned int& ID,
												 VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantProjectMatrix(VSShader * pShader, unsigned int& ID,
	VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantViewProjectMatrix(VSShader * pShader,unsigned int& ID,
															 VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantWorldViewMatrix(VSShader * pShader,unsigned int& ID,
									   VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantSkin(VSGeometry * pGeometry,VSShader * pShader,unsigned int& ID,
							VSString & OutString)
{
...
void VSDX12Renderer::CreateVUserConstant(VSVShader * pVShader,MaterialShaderPara &MSPara,unsigned int uiPassType,
										VSString & OutString)
{
...
void VSDX12Renderer::CreateVFuntionDualParaboloidPositionAndNormal(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
...
void VSDX12Renderer::CreateVFuntionPositionAndNormal(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
	VSVertexBuffer * pVBuffer = MSPara.pGeometry->GetMeshDate()->GetVertexBuffer();
...
void VSDX12Renderer::CreateVFuntionWorldPosition(MaterialShaderPara &MSPara,VSString & FuntionBody,unsigned int uiPass)
{
	VSVertexBuffer * pVBuffer = MSPara.pGeometry->GetMeshDate()->GetVertexBuffer();
	FuntionBody +=_T("float3 Position;\n");
...
void VSDX12Renderer::CreateVFuntionLocalPosition(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
	FuntionBody +=_T("Out.Pos = Position;\n");	
}
void VSDX12Renderer::CreateVFuntionColor(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
	VSVertexBuffer * pVBuffer = MSPara.pGeometry->GetMeshDate()->GetVertexBuffer();
	for(unsigned int i = 0 ; i < pVBuffer->GetColorLevel(); i++)
	{
...
void VSDX12Renderer::CreateVFuntionTexCoord(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
	VSVertexBuffer * pVBuffer = MSPara.pGeometry->GetMeshDate()->GetVertexBuffer();
	for(unsigned int i = 0 ; i < pVBuffer->GetTexCoordLevel(); i++)
	{
...
void VSDX12Renderer::CreateVFuntionPosition(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
	VSVertexBuffer * pVBuffer = MSPara.pGeometry->GetMeshDate()->GetVertexBuffer();
	FuntionBody +=_T("float3 Position;\n");
...
void VSDX12Renderer::CreateVFuntionProjectZ(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
	FuntionBody += _T("Out.ProjectZ = Out.Position.z / Out.Position.w;\n");
}
void VSDX12Renderer::CreateVFuntion(MaterialShaderPara &MSPara,unsigned int uiPassType,
								   VSString & OutString)
{
...
void VSDX12Renderer::CreateVFuntionPost(MaterialShaderPara &MSPara,VSString & FuntionBody)
{
...
void VSDX12Renderer::CreatePInputDeclareTexCoord(VSVertexBuffer * pVBuffer,unsigned int& ID,
								 VSString & OutString)
{
	for(unsigned int i = 0 ; i < pVBuffer->GetTexCoordLevel(); i++)
	{
...
void VSDX12Renderer::CreatePInputDeclareNormal(VSVertexBuffer * pVBuffer,unsigned int& ID,
							   VSString & OutString)
{
	if(pVBuffer->HaveNormalInfo(0))
	{
...
void VSDX12Renderer::CreatePInputDeclareColor(VSVertexBuffer * pVBuffer,
							  VSString & OutString)
{
	for(unsigned int i = 0 ; i < pVBuffer->GetColorLevel(); i++)
	{
...
void VSDX12Renderer::CreatePInputDeclareLocalPos(unsigned int& ID,
								 VSString & OutString)
{
	VSString TextureID = IntToString(ID);
	OutString += _T("float3 Pos:TEXCOORD") + TextureID + _T(";\n");
...
void VSDX12Renderer::CreatePInputDeclareWorldPos(unsigned int& ID,
												VSString & OutString)
{
	VSString TextureID = IntToString(ID);
...
void VSDX12Renderer::CreatePInputDeclareProjectPos(unsigned int& ID,
							  VSString & OutString)
{
	VSString TextureID = IntToString(ID);
	OutString += _T("float4 ProjectPos:TEXCOORD") + TextureID + _T(";\n");
...
void VSDX12Renderer::CreatePInputDeclareProjectZ(unsigned int& ID,
								 VSString & OutString)
{
	VSString TextureID = IntToString(ID);
	OutString += _T("float ProjectZ:TEXCOORD") + TextureID + _T(";\n");
...
void VSDX12Renderer::CreatePInputDeclare(MaterialShaderPara &MSPara, unsigned int uiPassType,
	VSString & OutString)
{
	VSString TempDeclare;
...
void VSDX12Renderer::CreatePOutputDeclare(MaterialShaderPara &MSPara,unsigned int uiPassType,
										 VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantWorldMatrix(VSShader * pShader,unsigned int& ID,
												  VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantCameraWorldPos(VSShader * pShader,unsigned int& ID,
													 VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantDirectionLight(VSShader * pShader,unsigned int& ID,unsigned int uiLightNum,
													 VSString & OutString)
{
	if (uiLightNum > 0)
	{
...
void VSDX12Renderer::CreateUserConstantPointLight(VSShader * pShader,unsigned int& ID,unsigned int uiLightNum,
												 VSString & OutString)
{
	if (uiLightNum > 0)
	{
...
void VSDX12Renderer::CreateUserConstantSpotLight(VSShader * pShader,unsigned int& ID,unsigned int uiLightNum,
												VSString & OutString)
{
	if (uiLightNum > 0)
	{
...
void VSDX12Renderer::CreateUserConstantLightFuntion(VSPShader* pPShader,VSArray<VSLight*> & LightArray,unsigned int &ID,VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantShadow(VSPShader* pPShader,VSArray<VSLight*> & LightArray,unsigned int &ID,VSString & OutString)
{
...
void VSDX12Renderer::CreateGBufferSampler(VSPShader* pPShader, MaterialShaderPara &MSPara, unsigned int &uiTexRegisterID, VSString & OutString)
{
...
void VSDX12Renderer::CreateLightModleLookUpTable(VSPShader* pPShader,MaterialShaderPara &MSPara, unsigned int &uiTexRegisterID,VSString & OutString)
{
	VSMaterial * pMaterial = MSPara.pMaterialInstance->GetMaterial();
...
void VSDX12Renderer::CreateUserConstantFarZ(VSShader * pShader,unsigned int& uiRegisterID,
							VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantSkyLightUpColor(VSShader * pShader,unsigned int& uiRegisterID,
									   VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantSkyLightDownColor(VSShader * pShader,unsigned int& uiRegisterID,
										 VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantPointLightRange(VSShader * pShader,unsigned int& uiRegisterID,
									   VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantInvRTWidth(VSShader * pShader,unsigned int& uiRegisterID,
							   VSString & OutString)
{
...
void VSDX12Renderer::CreateUserConstantLight(VSShader * pShader,MaterialShaderPara &MSPara,unsigned int& uiRegisterID,
							 VSString & OutString)
{
...
void VSDX12Renderer::CreatePUserConstant(VSPShader* pPShader,MaterialShaderPara &MSPara,unsigned int uiPassType,
										VSString & OutString)
{
...
void VSDX12Renderer::CreatePFuntion(MaterialShaderPara &MSPara,unsigned int uiPassType,
								   VSString & OutString)
{
	if (uiPassType == VSPass::PT_MATERIAL)
	{
...
void VSDX12Renderer::SkyLight(const VSString &WorldNormal,const VSString &UpColor,const VSString & DownColor,const VSString & DiffuseColor,VSString & OutString)
{
	OutString += _T(" + SkyLight(") + WorldNormal + _T(",") + UpColor + _T(",") + DownColor + _T(") * ") + DiffuseColor;
}
void VSDX12Renderer::CustomDirectionalLight(int iLightNum,const VSString &CustomString,VSArray<VSString> ShadowString,VSString & OutString)const
{
...
void VSDX12Renderer::DirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,const VSString &SpecularPow,
...
void VSDX12Renderer::SchlickDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,const VSString &SpecularPow,
									 const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
	{
...
void VSDX12Renderer::IsotropicWardDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Specular , 
...
void VSDX12Renderer::AnisotropicWardDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Specular , 
...
void VSDX12Renderer::CookTorranceDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Specular , 
...
void VSDX12Renderer::OrenNayarDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &RoughnessSquared,
...
void VSDX12Renderer::MinnaertDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Power,
									  const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
									  VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
...
void VSDX12Renderer::StraussDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Specular,const VSString &Smoothness,
...
void VSDX12Renderer::ShirleyDirectionalLight(int iLightNum,const VSString &Diffuse,const VSString &Specular,
...
void VSDX12Renderer::PointLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,const VSString &SpecularPow,
...
void VSDX12Renderer::CustomPointLight(int iLightNum, const VSString &CustomString,const VSString & WorldPos,VSArray<VSString> ShadowString,VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
	{
		VSString ID = IntToString(i);
...
void VSDX12Renderer::SchlickPointLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,const VSString &SpecularPow,
							   const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
							   VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
...
void VSDX12Renderer::OrenNayarPointLight(int iLightNum,const VSString &Diffuse,const VSString &RoughnessSquared,
...
void VSDX12Renderer::MinnaertPointLight(int iLightNum,const VSString &Diffuse,const VSString &Power,
								const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
								VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
...
void VSDX12Renderer::StraussPointLight(int iLightNum,const VSString &Diffuse,const VSString &Specular,const VSString &Smoothness,
										   const VSString &Metalness,const VSString &Transparency,const VSString &K,
										   const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,bool bLookUpTable,VSArray<VSString> ShadowString,
										   VSString & OutString)const
{
...
void VSDX12Renderer::IsotropicWardPointLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,
									 const VSString &Roughness ,
									 const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,bool bLookUpTable,VSArray<VSString> ShadowString,
									 VSString & OutString)const
{
...
void VSDX12Renderer::AnisotropicWardPointLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,
									   const VSString &RoughnessX ,const VSString &RoughnessY ,
									   const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
									   VSString & OutString)const
{
...
void VSDX12Renderer::CookTorrancePointLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,
									const VSString &Roughness , const VSString &C , const VSString &R,
...
void VSDX12Renderer::ShirleyPointLight(int iLightNum,const VSString &Diffuse,const VSString &Specular,
							   const VSString &NU,const VSString &NV,const VSString &Rs,
							   const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
							   VSString & OutString)const
{
...
void VSDX12Renderer::SpotLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,const VSString &SpecularPow,
					   const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
					   VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
...
void VSDX12Renderer::CustomSpotLight(int iLightNum,const VSString &CustomString,const VSString & WorldPos,VSArray<VSString> ShadowString,VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
	{
		VSString ID = IntToString(i);
...
void VSDX12Renderer::SchlickSpotLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,const VSString &SpecularPow,
							  const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
							  VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
...
void VSDX12Renderer::OrenNayarSpotLight(int iLightNum,const VSString &Diffuse,const VSString &RoughnessSquared,
								const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,bool bLookUpTable,VSArray<VSString> ShadowString,
								VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
...
void VSDX12Renderer::MinnaertSpotLight(int iLightNum,const VSString &Diffuse,const VSString &Power,
								const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
								VSString & OutString)const
{
	for (int i = 0 ; i < iLightNum ; i++)
...
void VSDX12Renderer::StraussSpotLight(int iLightNum,const VSString &Diffuse,const VSString &Specular,const VSString &Smoothness,
							  const VSString &Metalness,const VSString &Transparency,const VSString &K,
							  const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,bool bLookUpTable,VSArray<VSString> ShadowString,
							  VSString & OutString)const
{
...
void VSDX12Renderer::IsotropicWardSpotLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,
									const VSString &Roughness ,
									const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,bool bLookUpTable,VSArray<VSString> ShadowString,
									VSString & OutString)const
{
...
void VSDX12Renderer::AnisotropicWardSpotLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,
									  const VSString &RoughnessX ,const VSString &RoughnessY ,
									  const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
									  VSString & OutString)const
{
...
void VSDX12Renderer::CookTorranceSpotLight(int iLightNum,const VSString &Diffuse,const VSString &Specular ,
								   const VSString &Roughness , const VSString &C , const VSString &R,
								   const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,unsigned int uiSpecularType,VSArray<VSString> ShadowString,
								   VSString & OutString)const
{
...
void VSDX12Renderer::ShirleySpotLight(int iLightNum,const VSString &Diffuse,const VSString &Specular,
							  const VSString &NU,const VSString &NV,const VSString &Rs,
							  const VSString & WorldPos,const VSString &WorldNormal,const VSString &WorldCameraDir,VSArray<VSString> ShadowString,
							  VSString & OutString)const
{
...
void VSDX12Renderer::LocalToWorldPos(const VSString & LocalPos,VSString &OutString)const
{
	OutString += _T("TransPos(") + LocalPos + _T(",") + 
					VSShaderStringFactory::ms_WorldMatrix + _T(")");
}
void VSDX12Renderer::WorldToViewPos(const VSString & WorldPos,VSString &OutString)const
{
	OutString += _T("TransPos(") + WorldPos + _T(",") + 
		VSShaderStringFactory::ms_ViewMatrix + _T(")");
}

void VSDX12Renderer::TransProjPos(const VSString & Pos,const VSString & Matrix,VSString &OutString)const
{
	OutString += _T("TransProjPos(") + Pos + _T(",") + Matrix + _T(")");
}

void VSDX12Renderer::LocalToViewNormal(const VSString & LocalNormal,VSString &OutString)const
{
	OutString += _T("TransNormal(") + LocalNormal + _T(",") + 
		VSShaderStringFactory::ms_WorldViewMatrix + _T(")");
}

void VSDX12Renderer::LocalToWorldNormal(const VSString & LocalNormal,VSString &OutString)const
{
	OutString += _T("TransNormal(") + LocalNormal + _T(",") + 
		VSShaderStringFactory::ms_WorldMatrix + _T(")");
}

void VSDX12Renderer::GetWorldViewDir(VSString &OutString)const
{
	OutString += _T("GetZDir(") + VSShaderStringFactory::ms_ViewMatrix + _T(")");
	
}

void VSDX12Renderer::WorldToViewNormal(const VSString & WorldNormal,VSString &OutString)const
{
	OutString += _T("TransNormal(") + WorldNormal + _T(",") + 
		VSShaderStringFactory::ms_ViewMatrix + _T(")");
}

void VSDX12Renderer::BumpNormal(const VSString &TexNormal,VSString &OutString)const
{
...
void VSDX12Renderer::ComputeDir(const VSString & Orgin,const VSString & End,VSString &OutString)const
{
	OutString += _T("ComputeDir(") + Orgin + _T(",")
				+ End + _T(")");
}

void VSDX12Renderer::ComputeLength(const VSString & Orgin,const VSString & End,VSString &OutString)const
{
	OutString += _T("ComputeLength(") + Orgin + _T(",")
		+ End + _T(")");
}

void VSDX12Renderer::GetLightType(unsigned int i,VSString &OutString)const
{
...
void VSDX12Renderer::GetLightTypeTemp(VSString &OutString)const
{
...
void VSDX12Renderer::ComputeBoneVector(const VSString& BoneIndex, const VSString & BoneWeight,const VSString &BoneVector,
...
void VSDX12Renderer::BoneTranPos( const VSString & LocalPos,const  VSString & U,const VSString & V,const VSString &N,VSString &OutString)const
{
	OutString += _T("TransPos(") + LocalPos + _T(",") +  U + _T(",") + V + _T(",") + N  + _T(")");
}

 void VSDX12Renderer::BoneTranNormal( const VSString & LocalNormal,const  VSString & U,const VSString & V,const VSString &N,VSString &OutString)const
{
	OutString += _T("TransNormal(") + LocalNormal + _T(",") +  U + _T(",") + V + _T(",") + N  + _T(")");
}

void VSDX12Renderer::DecodeNormal1(const VSString & Normal,VSString &OutString) const
{
	OutString += _T("DecodeNormal1(") + Normal + _T(")");
}

void VSDX12Renderer::RecodeNormal1(const VSString & Normal,VSString &OutString) const
{
	OutString += _T("RecodeNormal1(") + Normal + _T(")");
}

void VSDX12Renderer::DecodeNormal2(const VSString & Normal,const VSString & Tengent,VSString &OutString) const
{
	OutString += _T("DecodeNormal2(") + Normal + _T(",") + Tengent + _T(")");
}

void VSDX12Renderer::DecodeNormal3(const VSString & Normal,VSString &OutString) const
{
	OutString += _T("DecodeNormal3(") + Normal + _T(")");
}

void VSDX12Renderer::RecodeNormal3(const VSString & Normal,VSString &OutString) const
{
	OutString += _T("RecodeNormal3(") + Normal + _T(")");
}

void VSDX12Renderer::EncodeReflect(const VSString & Mip , const VSString & Pow , VSString& OutString)
{
	OutString += _T("EncodeReflect(") + Mip + _T(",") + Pow + _T(")");
}

void VSDX12Renderer::DecodeReflect(const VSString & Mip , const VSString & Pow , const VSString & Value,VSString& OutString)
{
	OutString += _T("DecodeReflect(") + Mip + _T(",") + Pow + _T(",") + Value + _T(")");
}

void VSDX12Renderer::GreaterZeroPow(const VSString & Value,VSREAL Exp,VSString &OutString) const
{
	VSString SExp = RealToString(Exp);
	OutString += _T("GreaterZeroPow(") + Value + _T(",") + SExp + _T(")");
}

void VSDX12Renderer::Reciprocal(const VSString & Value, VSString &OutString)const
{
	OutString += _T("1.0 / (") + Value + _T(")");
}

void VSDX12Renderer::Clip(const VSString & ClipValue,VSString &OutString)const
{
	OutString += _T("clip(") + ClipValue + _T(")");
}

void VSDX12Renderer::SaturatePow(const VSString & Value,VSREAL Exp,VSString &OutString) const
{
	VSString SExp = RealToString(Exp);
	OutString += _T("SaturatePow(") + Value + _T(",") + SExp + _T(")");
}

void VSDX12Renderer::Saturate(const VSString & Value,VSString &OutString)const
{
	OutString += _T("saturate(") + Value + _T(")");
}

void VSDX12Renderer::PointLightCubeShadow(const VSString & PointLightName , const VSString & CubeShadowSampler , const VSString & ViewMatrix,
...
void VSDX12Renderer::PointLightCubeShadow(const VSString & PointLightName , const VSString & CubeShadowSampler ,
										 const VSString & WorldPos, VSString &OutString)const
{
...
void VSDX12Renderer::PointLightVolumeShadow(const VSString & PointLightName , const VSString & VolumeShadowSampler , 
									const VSString & WorldPos, VSString& OutString)const
{
...
void VSDX12Renderer::PointLightDualParaboloidShadow(const VSString & PointLightName , const VSString & ShadowSampler ,  
											const VSString & WorldPos, VSString& OutString)const
{
...
void VSDX12Renderer::DirectionLightVolumeShadow(const VSString & DirLightName , const VSString & VolumeShadowSampler , 
										const VSString & WorldPos, VSString& OutString)const
{
...
void VSDX12Renderer::DirectionLightCSMShadow(const VSString & DirLightName , const VSString & ShadowSampler , 
...
void VSDX12Renderer::DirectionLightShadow(const VSString & DirLightName , const VSString & ShadowSampler , 
								  const VSString & WorldPos, VSString& OutString)const
{
	OutString += _T("DirLightShadow(") + DirLightName + _T(",") + WorldPos + _T(",") + ShadowSampler + _T("Sampler,") + ShadowSampler + _T("Texture)");
}

void VSDX12Renderer::SpotLightShadow(const VSString & SpotLightName , const VSString & ShadowSampler , 
							 const VSString & WorldPos, VSString& OutString)const
{
	OutString += _T("SpotLightShadow(") + SpotLightName + _T(",") + WorldPos + _T(",") + ShadowSampler + _T("Sampler,") + ShadowSampler + _T("Texture)");
}

void VSDX12Renderer::GetLightFunction(VSArray<VSLight *> LightArray,const VSString & WorldPos,VSString & OutString)const
{
...
void VSDX12Renderer::TranLightToTemp(VSArray<VSLight *> LightArray,VSString & OutString)const
{
	unsigned int iLightNum[VSLight::LT_MAX] = { 0 };	
	for (unsigned int i = 0 ; i < LightArray.GetNum() ; i++)
	{
...
void VSDX12Renderer::CreateGInputDeclare(MaterialShaderPara &MSPara, unsigned int uiPassType,
	VSString & OutString){}
void VSDX12Renderer::CreateGOutputDeclare(MaterialShaderPara &MSPara, unsigned int uiPassType,
	VSString & OutString){}
void VSDX12Renderer::CreateGUserConstant(VSGShader * pGShader, MaterialShaderPara &MSPara, unsigned int uiPassType,
	VSString & OutString){}
void VSDX12Renderer::CreateGFuntion(MaterialShaderPara &MSPara, unsigned int uiPassType,
	VSString & OutString){}
void VSDX12Renderer::SetMaterialGShaderConstant(MaterialShaderPara &MSPara, unsigned int uiPassType, VSGShader *pGShader){}